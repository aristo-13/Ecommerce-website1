 ...
 useEffect(() => {
  ...
  return (
    <>
         ...
         {!image && <div className='p-4 min-h-[300px] w-[min(100%,250px)] rounded-2xl  border-4 overflow-hidden border-white cursor-pointer hover:scale-[1.05] hover:z-[1] duration-500 bg-gray-500 animate-pulse shadow-2xl'></div>}
